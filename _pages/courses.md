...
- 11-485: This class isn't for everyone, since it takes 20 hours a week of your time. The professor, Bhiksha Raj, is kind, passionate, and it is easy to tell that he genuinely loves the subject material. I learned a lot about both fundamentals of deep learning through the "Part 1" assignments, and how to apply these concepts to real-world problems through the "Part 2" assignments. Don't underestimate the difficulty of this class. It's really hard and the hours spent on it are comparable to OS or compilers. Having friends in the class helped a lot.
